...
?>
				  ...
				  <div class="col-sm-10">
                    <input type="text" name="pname" class="form-control" value="<?php echo $value->pname;  ?>"  placeholder="Product Name">
                  </div>
                </div>
				<div class="form-group">
                  <label  class="col-sm-2 control-label">Description</label>
				  <div class="col-sm-10">
          <textarea name="description" class="form-control" rows="3"><?php echo $value->description;  ?></textarea>
                  </div>
                </div>
                <div class="form-group">
                  <label  class="col-sm-2 control-label">Price</label>
				  <div class="col-sm-10">
                    <input type="text" name="price" class="form-control" value="<?php echo $value->price;  ?>"  placeholder="price">
                  </div>
                </div>
                <div class="form-group">
			...
			<select name="category" class="form-control" id="sel1">
                    	...
                    	<?php foreach ($get_category as $i)
                    		{
                    	?>
        				<option value="<?php echo $i->cid; ?>" <?php echo ($value->id == $i->cid)?"Selected":"" ?> ><?php echo $i->cname ; ?></option>
        				<?php } ?>
      				</select>
			</div>
		</div>
